 ...
 *
 * @link https://github.com/radyakaze/
 *
 * @license GPL-3.0
 */
...
class Bot
{
    ...
    public static function send($action = 'sendMessage', $data = [])
    {
        ...
        $ch = curl_init();
        $options = [
            CURLOPT_URL => 'https://api.telegram.org/bot'.robot::$token.'/'.$action,
            CURLOPT_POST => true,
        ...
        if (robot::$debug && $action != 'getUpdates') {
